...
#reader(lib "vanilla-reader.rkt" "deinprogramm" "sdp")((modname 19_1_systematische_Abstraktion) (read-case-sensitive #f) (teachpacks ((lib "image.rkt" "teachpack" "deinprogramm" "sdp") (lib "universe.rkt" "teachpack" "deinprogramm" "sdp"))) (deinprogramm-settings #(#f write repeating-decimal #f #t none explicit #f ((lib "image.rkt" "teachpack" "deinprogramm" "sdp") (lib "universe.rkt" "teachpack" "deinprogramm" "sdp")))))
...
;               eine function   liste v. typ a  filterliste
...
; lambda aus c# list.Where(a => a.Id); Where(a => a.Id) ist p? ; list ist diese Liste hier ;
...
;----- Aufgaben ab hier -----
; 1.
(: list-map (list-of-number -> boolean))

; (check-expect (list-map ...) ...)
